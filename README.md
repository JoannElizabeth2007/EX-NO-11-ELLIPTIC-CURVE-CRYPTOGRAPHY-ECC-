...
Point scalarMultiplication(Point P, long long int k, long long int a, long long int
p)
{
Point result = P;
k--;
...
<img width="876" height="425" alt="image" src="https://github.com/user-attachments/assets/9b903bdb-d7e7-46b8-8d52-1f28d39fe236" />
